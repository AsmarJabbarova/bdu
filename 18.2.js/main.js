...
// let result = product.filter((a)=>a.name.toLowerCase().trim().includes(text.toLowerCase().trim()))
// console.log(result);

// 3-

// let result = product.filter((a)=>a.discontinued)
// console.log(result);

// 4-
// let result = product.filter((a)=>a.unitPrice>22)
// console.log(result);

// 5-

// let result = product.filter((a)=> a.supplier?.address.country==`Spain`);
// console.log(result);


// MATH OBJECT

// 1- ededi yuxari mertebesine yuvarlaqlasdirin.
// let number = Number(prompt(`enter number:`))
// console.log(Math.ceil(number));


// 2- ededi asagi mertebeye yuvarlaqlasdirsin
// let number = Number(prompt(`enter number:`))
// console.log(Math.floor(number));

// 3--ededi yuvarlaqlasdirin
// let number = Number(prompt(`enter number:`))
// console.log(Math.round(number));

// 4-- ededin verilmis quvvetini tapin
// let number = Number(prompt(`enter number:`))
// let power = Number(prompt(`enter power:`))
// console.log(Math.pow(number,power));


// 5--ededin 2 ci dereceli kok altisini tapin
// let number = Number(prompt(`enter number:`))
